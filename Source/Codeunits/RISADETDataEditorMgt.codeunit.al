...
codeunit 81001 "RISA DET Data Editor Mgt."
{
    ...
    var
        ...
        DataEditorSetup: Record "RISA DET Data Editor Setup";
        EditValue: page "RISA DET Edit Value";
    ...
    var
        SingleInstanceStorage: Codeunit "RISA DET Single Inst. Storage";
    ...
    var
        ...
        ImportExportDialog: Page "RISA DET Import/Export Dialog";
        ImportOnFind: Enum "RISA DET Import On Find";
        FileFormat: Enum "RISA DET File Format";
    ...
    local procedure ImportExcel(var FileInStream: InStream; ImportOnFind: Enum "RISA DET Import On Find"; WithValidation: Boolean)
    var
    ...
    local procedure ImportJSON(var FileInStream: InStream; ImportOnFind: Enum "RISA DET Import On Find"; WithValidation: Boolean)
    var
        DataEditorSetup: Record "RISA DET Data Editor Setup";
        RecRef: RecordRef;
        xRecRef: RecordRef;
    ...
    local procedure UpdateRecord(ValueAsTxt: Text; var RecRef: RecordRef; var xRecRef: RecordRef; var FieldRef: FieldRef; ImportOnFind: Enum "RISA DET Import On Find"; IsRecordExist: Boolean; WithValidation: Boolean; IsLogEnabled: Boolean)
    var
        xFieldRef: FieldRef;
    begin
    ...
    local procedure SaveRecord(var RecRef: RecordRef; ImportOnFind: Enum "RISA DET Import On Find"; WithValidation: Boolean; IsRecordExist: Boolean; var Inserted: Integer; var Skipped: Integer; var Modified: Integer; IsLogEnabled: Boolean)
    begin
    ...
    procedure ExportTable(var DataEditorBuffer: Record "RISA DET Data Editor Buffer"; FieldIdsToExport: List of [Integer])
    var
        ImportExportDialog: Page "RISA DET Import/Export Dialog";
        FileFormat: Enum "RISA DET File Format";
    ...
    local procedure ExportExcel(var DataEditorBuffer: Record "RISA DET Data Editor Buffer"; FieldIdsToExport: List of [Integer]; ExportBLOB: Boolean; ExportMedia: Boolean)
    var
        TempExcelBuffer: Record "Excel Buffer" temporary;
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    var
        TempBinaryDataBuffer: Record "RISA DET Binary Data Buffer" temporary;
        TempBlob: Codeunit "Temp Blob";
    ...
    local procedure ExportJSON(var DataEditorBuffer: Record "RISA DET Data Editor Buffer"; FieldIdsToExport: List of [Integer]; ExportBLOB: Boolean; ExportMedia: Boolean)
    var
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    var
        ...
        NewValue: FieldRef;
    begin
        Log(Enum::"RISA DET Log Action Type"::Insert, SourceRecordId, TableNo, 0, OldValue, NewValue, WithValidation, false);
    end;
    ...
    var
        ...
        NewValue: FieldRef;
    begin
        Log(Enum::"RISA DET Log Action Type"::Delete, SourceRecordId, TableNo, 0, OldValue, NewValue, WithValidation, false);
    end;
    ...
    begin
        Log(Enum::"RISA DET Log Action Type"::Modify, SourceRecordId, TableNo, FieldNo, OldValue, NewValue, WithValidation, true);
    end;
    ...
    begin
        Log(Enum::"RISA DET Log Action Type"::Rename, SourceRecordId, TableNo, FieldNo, OldValue, NewValue, WithValidation, true);
    end;

    procedure Log(ActionType: Enum "RISA DET Log Action Type"; SourceRecordId: RecordId;
                                  TableNo: Integer;
                                  FieldNo: Integer;
                                  OldValue: FieldRef;
                                  NewValue: FieldRef;
                                  ...
                                  HasValues: Boolean)
    var
        DataEditorLog: Record "RISA DET Data Editor Log";
    begin
    ...
    begin
        if TableNo in [Database::"RISA DET Data Editor Setup", Database::"RISA DET Data Editor Log"] then
    ...
    procedure ReadRecord(var TempDataEditorBuffer: Record "RISA DET Data Editor Buffer" temporary; JObject: JsonObject; NumberOfThreads: Integer; TotalRecordCount: Integer) ActiveSessionId: Integer
    var
    ...
    begin
        ...
        if (NumberOfThreads > 1) and (TotalRecordCount > 500) then
            StartSession(ActiveSessionId, Codeunit::"RISA DET Read Data Batch", CompanyName(), TempDataEditorBuffer)
        else
            Codeunit.Run(Codeunit::"RISA DET Read Data Batch", TempDataEditorBuffer);
    end;

    procedure MergeBufferData(var TempDataEditorBufferResult: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer1: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer2: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer3: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer4: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer5: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer6: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer7: Record "RISA DET Data Editor Buffer" temporary;
        var TempDataEditorBuffer8: Record "RISA DET Data Editor Buffer" temporary)
    var
        PrevFilters: Text;
    begin
