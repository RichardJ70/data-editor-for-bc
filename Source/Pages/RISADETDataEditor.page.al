...
page 81001 "RISA DET Data Editor"
{
    ...
    UsageCategory = Tasks;
    InsertAllowed = false;
    AccessByPermission = tabledata "RISA DET Data Editor Buffer" = RIMD;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field(PresetCodeField; PresetCode)
                {
                    ...
                    trigger OnLookup(var Text: Text): Boolean
                    var
                        QueryPreset: Record "RISA DET Query Preset";
                        QueryPresetList: Page "RISA DET Query Preset";
                    begin
    ...
    var
        DataEditorBufferList: Page "RISA DET Data Editor Buffer";
    begin
    ...
    local procedure LoadPreset(var QueryPreset: Record "RISA DET Query Preset")
    var
